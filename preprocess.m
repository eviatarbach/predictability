...
save('data/sst_15.mat', 'sst_15');
save('data/vort_15.mat', 'vort_15');
...
save('data/sst_01.mat', 'sst_daily');
save('data/vort_01.mat', 'vort_daily');
...
save('data/sst_05.mat', 'sst_pentad');
save('data/vort_05.mat', 'vort_pentad');
